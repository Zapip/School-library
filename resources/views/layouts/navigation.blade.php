            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->isAdmin())
                        ...
                        <x-nav-link :href="route('admin.menfess.index')" :active="request()->routeIs('admin.menfess.*')">
                            {{ __('Moderasi Menfess') }}
                        </x-nav-link>
                    @else
                        ...
                        <x-nav-link :href="route('menfess.index')" :active="request()->routeIs('menfess.*')">
                            {{ __('Menfess') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.menfess.index')" :active="request()->routeIs('admin.menfess.*')">
                    {{ __('Moderasi Menfess') }}
                </x-responsive-nav-link>
            @else
                ...
                <x-responsive-nav-link :href="route('menfess.index')" :active="request()->routeIs('menfess.*')">
                    {{ __('Menfess') }}
                </x-responsive-nav-link>
            @endif
        </div>
